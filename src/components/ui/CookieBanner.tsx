  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto pointer-events-auto">
        <div className="metallic-border premium-glow p-6 md:p-8 rounded-lg relative overflow-hidden group">
          {/* Subtle metallic reflection effect */}
          <div className="absolute top-0 left-0 w-full h-1 primary-gradient opacity-30 group-hover:opacity-60 transition-opacity duration-500" />
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div className="flex-1 space-y-2">
              ...
              <p className="text-zinc-400 text-sm md:text-base max-w-2xl leading-relaxed">
                We use cookies to enhance your experience. By clicking &quot;Accept&quot;, you agree to our use of cookies for analytics and personalization.
              </p>
            </div>
