      ...
      <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
        ...
        <div className="space-y-6">
          ...
          <div className="flex gap-4">
            ...
            <Linkedin size={20} className="text-white/40 hover:text-gold transition-colors cursor-pointer" />
          </div>
        </div>
        ...
        <div className="space-y-6">
          ...
          <ul className="space-y-4">
            <li><a href="#about" className="text-white/50 hover:text-gold text-sm transition-colors">Despre Noi</a></li>
            <li><a href="#services" className="text-white/50 hover:text-gold text-sm transition-colors">Servicii</a></li>
            <li><a href="#portfolio" className="text-white/50 hover:text-gold text-sm transition-colors">Portofoliu</a></li>
            <li><a href="#contact" className="text-white/50 hover:text-gold text-sm transition-colors">Contact</a></li>
          </ul>
        </div>
        ...
        {/* Legal Info */}
        <div className="space-y-6">
          <h4 className="text-white font-bold uppercase tracking-widest text-sm">Date Firmă</h4>
          <ul className="space-y-4 text-white/50 text-sm">
            <li>CUI: {SITE_CONTENT.contact.legal.cui}</li>
            <li>Reg. Com: {SITE_CONTENT.contact.legal.regCom}</li>
          </ul>
        </div>
      </div>
      ...
      <div className="container mx-auto px-6 pt-10 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        <div className="flex gap-8">
          {SITE_CONTENT.footer.legalLinks.map((link) => (
            <a key={link.label} href={link.href} className="text-white/30 hover:text-white text-xs transition-colors">
              {link.label}
            </a>
          ))}
        </div>
